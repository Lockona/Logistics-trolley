...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_13 | GPIO_Pin_12 | GPIO_Pin_5 | GPIO_Pin_7;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;  //????
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; //??50MHz
	GPIO_Init(GPIOB, &GPIO_InitStructure);			  //???GPIOD3,6
	GPIO_SetBits(GPIOB, GPIO_Pin_0 | GPIO_Pin_13 | GPIO_Pin_12 | GPIO_Pin_5 | GPIO_Pin_7);
