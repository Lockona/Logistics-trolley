...
(cl:defmethod cl:initialize-instance :after ((m <person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-msg:<person> is deprecated: use test-msg:person instead.")))
...
(cl:defmethod sex-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:sex-val is deprecated.  Use test-msg:sex instead.")
  (sex m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-msg:age-val is deprecated.  Use test-msg:age instead.")
  (age m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<person>)))
  ...
  "f8ac7f42dd02e4aea0ff112097d249f1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'person)))
  "Returns md5sum for a message object of type 'person"
  "f8ac7f42dd02e4aea0ff112097d249f1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<person>)))
  ...
  (cl:format cl:nil "string name~%uint8 sex~%uint8 age~%~%uint8 male = 0~%uint8 female = 1~%uint8 unknow = 2~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'person)))
  "Returns full string definition for message of type 'person"
  (cl:format cl:nil "string name~%uint8 sex~%uint8 age~%~%uint8 male = 0~%uint8 female = 1~%uint8 unknow = 2~%~%"))
